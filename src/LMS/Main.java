...
public class Main {
        ...
        while (true) {
            ...
            switch (checkValidCommand()) {
                case 1 -> {
                    ...
                    String email1 = scanForStr.nextLine();
                    System.out.print("паролунузду жазыныз: ");
                    String password1 = scanForStr.nextLine();
                    studentService.savedDefaultAdmin();
                    Student student = null;
                    try {
                        student = studentService.singIn(email1, password1);
                    ...
                    if (student.getRole().equals(Role.ADMIN)) {
                        ...
                        while (loop) {
                            ...
                            switch (checkValidCommand()) {
                                ...
                                case 1 -> {
                                    groupService.addGroup(addScanGroup(new Group()));
                                ...
                                case 3 -> {
                                    ...
                                    String name = scanForStr.nextLine();
                                    groupService.updateGroup(name, addScanGroup(new Group()));
                                }
                                case 4 -> {
                                ...
                                case 5 -> {
                                    ...
                                    String name = scanForStr.nextLine();
                                    studentService.addStudent(name, addScanStudent(new Student()));
                                }
                                case 6 -> {
                                    ...
                                    studentService.updateStudent(email, password, addScanStudent(new Student()));
                                }
                                case 7 -> {
                                ...
                                case 11 -> {
                                    ...
                                    String name = scanForStr.nextLine();
                                    lessonService.addLesson(name, addScanLesson(new Lesson()));
                                }
                                case 12 -> {
                        ...
                        switch (checkValidCommand()) {
                            case 1 -> {
                                ...
                                System.out.print("Пароль жазыныз: ");
                                String password = scanForStr.nextLine();
                                studentService.getAllLessonStudents(email,password);
                            }
                        }
                    }
                }
    ...
    public static Group addScanGroup(Group group) {
    ...
    public static Lesson addScanLesson(Lesson lesson) {
        System.out.print("Enter lesson name: ");
    ...
    public static Student addScanStudent(Student student) {
